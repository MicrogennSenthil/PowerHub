...
// Storage routes use @google-cloud/storage which is loaded lazily in
// objectStorage.ts (no top-level ESM binding).  Only mount the router when
// the Replit bucket env-var is present; outside Replit photo uploads return
// 503 from the guarded handler rather than crashing the server.
